...
// CREATE COURSE
router.post('/', authenticateToken, isAdmin, verifyCsrfToken, csrfMiddleware, upload.single('image'), courseController.createCourse);
...
// UPDATE COURSE BY ID
router.put('/edit/:id', authenticateToken, isAdmin, verifyCsrfToken, csrfMiddleware, upload.single('image'), courseController.updateCourseById);

// DELETE COURSE BY ID
router.delete('/delete/:id', authenticateToken, isAdmin, verifyCsrfToken, csrfMiddleware, courseController.deleteCourseById);

// DELETE MANY COURSES
router.delete('/deleteMany', authenticateToken, isAdmin, verifyCsrfToken, csrfMiddleware, courseController.deleteManyCourses);
